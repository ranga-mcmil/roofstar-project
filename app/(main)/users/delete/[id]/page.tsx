...
export default function DeleteWarehousePage({ params }: DeletePageProps) {
  const { id } = params
        ...
        <div className="mx-auto max-w-md space-y-6 p-6 border rounded-lg shadow-sm">
          ...
          {hasAssignedUsers ? (
            <div className="bg-red-50 border border-red-200 rounded-md p-4 text-red-700">
              ...
              <p className="mt-1">
                This user has {assignedUsers.length} users assigned to it. Please reassign or remove these users
                first.
              </p>
            </div>
          ) : (
