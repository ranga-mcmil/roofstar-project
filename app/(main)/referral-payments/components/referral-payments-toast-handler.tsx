// app/(main)/referral-payments/components/referral-payments-toast-handler.tsx
'use client';
...
export function ReferralPaymentsToastHandler() {
  ...
  useEffect(() => {
    ...
    if (success) {
      const successMessages: Record<string, string> = {
        ...
        'paid': 'Payment marked as paid successfully',
        'cancelled': 'Payment cancelled successfully'
      };
      
      toast({
        title: "Status Updated",
        description: successMessages[success] || "Payment status updated successfully",
        variant: "default",
      });
